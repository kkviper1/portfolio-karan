...
const Projects = () => {
  return (
    <div id="projects" className="w-full min-h-screen snap-start bg-[#3b385a] text-[#ffffff]">
      <div className="max-w-[1240px] mx-auto px-2 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-[#080808] to-[#1d192e]">
            <Image className="rounded-xl group-hover:opacity-10" src={IELTS || "/placeholder.svg"} alt="/" />
          ...
          <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-[#080808] to-[#1d192e]">
            <Image className="rounded-xl group-hover:opacity-10" src={inference || "/placeholder.svg"} alt="/" />
          ...
          <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-[#080808] to-[#1d192e]">
            <Image className="rounded-xl group-hover:opacity-10" src={webd || "/placeholder.svg"} alt="/" />
            <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
              <h3 className="text-2xl text-white tracking-wider text-center">
          ...
          <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-[#080808] to-[#1d192e]">
            <Image className="rounded-xl group-hover:opacity-10" src={dota || "/placeholder.svg"} alt="/" />
            <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
              <h3 className="text-2xl text-white tracking-wider text-center">
          ...
          <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-[#080808] to-[#1d192e]">
            <Image className="rounded-xl group-hover:opacity-10" src={toxicity || "/placeholder.svg"} alt="/" />
            <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
