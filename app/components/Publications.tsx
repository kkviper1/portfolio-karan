...
const Publications = () => {
  return (
    <div id="publications" className="w-full min-h-screen snap-start bg-[#3b385a] text-[#ffffff]">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-[#080808] to-[#1d192e]">
            <Image className="rounded-xl group-hover:opacity-10" src={capsnet || "/placeholder.svg"} alt="/" />
